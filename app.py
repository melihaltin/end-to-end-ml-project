...
def index():
    if request.method == 'POST':
        try:
            ...
            data = {'age': [age], 'job': [job], 'marital': [marital], 'education': [education], 'default': [default], 'balance': [balance], 'housing': [housing], 'loan':[loan]  , 'contact': [contact], 'day': [day], 'month': [month], 'duration': [duration], 'pdays': [pdays], 'previous': [previous], 'poutcome': [poutcome], 'campaign': [campaign]}
